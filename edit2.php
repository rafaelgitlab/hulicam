...
include 'connections/db_connect.php';
 $sql = "SELECT * FROM monitoring_registration WHERE id = $id";
...
require 'connections/db_connect.php';
 if(isset($_POST["submit"])){ 
        ...
        $address = stripslashes($_POST['contact']); 
        $address = mysqli_real_escape_string($con,$contact);
...
$sql = "UPDATE monitoring_registration SET firstname = '$fn', middlename = '$mn', lastname = '$ln', contact = '$contact' WHERE id = $id";
