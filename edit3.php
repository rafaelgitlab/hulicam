...
include 'connections/db_connect.php'; 
 $sql = "SELECT * FROM admin_registration WHERE admin_id = $id";
...
$sql = "UPDATE admin_registration SET  firstname = '$fn', middlename = '$mn', lastname = '$ln', contact = '$contact', email = '$email', address = '$address' WHERE admin_id = $id";
